...
export default function Cart(props) {
  ...
  const delete_cart = async (e, id) => {
    e.preventDefault();
    const response = await fetch(process.env.REACT_APP_BURL+"/delete_cart", {
      method : "POST",
      headers : {
    ...
    if (response.ok) {
      ...
      if (data.success) {
        ...
        history.push('/user/'+(props.user.user_id)+'/cart')
      }else{
        alert(data.message)
      }
    }
                                ...
                                <table className="table">
                                    ...
                                    {props.cart && props.cart.items_cart.map((item) =>
                                        <tr>
                                            ...
                                            <div className="row">
                                            <div className="col"><Form> <Form.Control type="number" defaultValue={item.quantity} /></Form></div>
                ...
                <div className="row py-5 p-4 bg-white rounded shadow-sm">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="p-4">
                            ...
                            </ul><a href="/user/:id/checkout" className="btn btn-dark rounded-pill py-2 btn-block">Procceed to checkout</a>
                        </div>
                    </div>
                </div>
            </div>
